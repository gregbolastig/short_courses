            ...
            <div class="flex items-center justify-center py-6 sm:py-8">
                <div class="text-center">
                    <div class="flex flex-col sm:flex-row items-center justify-center">
                        ...
                        ?>
                        <img src="<?php echo $logo_path; ?>" alt="School Logo" class="h-14 w-14 sm:h-20 sm:w-20 object-cover rounded-full border-2 border-white/40 shadow-lg mb-3 sm:mb-0 sm:mr-5">
                        <?php endif; ?>
