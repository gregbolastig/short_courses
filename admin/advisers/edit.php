...
// Set page title
$page_title = 'Edit Adviser';

// Get adviser ID from URL
$adviser_id = isset($_GET['id']) ? intval($_GET['id']) : 0;
...
try {
    ...
    $stmt = $conn->prepare("SELECT * FROM advisers WHERE adviser_id = ?");
    ...
    // Update breadcrumb with adviser name
    $breadcrumb_items = [
        ['title' => 'Manage Advisers', 'icon' => 'fas fa-chalkboard-teacher', 'url' => 'index.php'],
        ['title' => 'Edit: ' . $adviser['adviser_name'], 'icon' => 'fas fa-edit']
    ];
...
// Parse existing name for form fields
$name_parts = explode(' ', $adviser['adviser_name']);
...
<head>
    ...
    <title>Edit Adviser - Student Registration System</title>
                    ...
                    <div class="max-w-7xl mx-auto px-3 sm:px-4 md:px-6 lg:px-8">
                        ...
                        <div class="mb-8 mt-6">
                            <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-6">
                                <div>
                                    <h1 class="text-3xl md:text-4xl font-bold text-gray-900 tracking-tight">Edit Adviser</h1>
