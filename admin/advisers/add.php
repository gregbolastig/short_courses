...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        ...
        $stmt = $conn->prepare("INSERT INTO advisers (adviser_name, email, phone, department, specialization) VALUES (?, ?, ?, ?, ?)");
                            ...
                            <div class="p-8">
                                <form method="POST" action="" class="space-y-8">
                                    ...
                                    <div>
                                        ...
                                        <p class="mt-2 text-sm text-gray-500">Enter the adviser's areas of expertise</p>
                                    </div>
