                    ...
                    <div class="max-w-7xl mx-auto px-3 sm:px-4 md:px-6 lg:px-8">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 mb-6 md:mb-8">
                            ...
                            <div class="bg-white overflow-hidden shadow-lg rounded-xl border border-gray-100 transition-all duration-300 hover:-translate-y-1 hover:shadow-2xl">
                                ...
                                <div class="bg-blue-50 px-4 md:px-6 py-3 border-t border-blue-100">
                                    <a href="admin-manage-students.php?page=index" class="text-sm text-blue-700 hover:text-blue-800 font-medium flex items-center transition-colors duration-200">
                                        View all students
                            ...
                            <div class="bg-white overflow-hidden shadow-lg rounded-xl border border-gray-100 transition-all duration-300 hover:-translate-y-1 hover:shadow-2xl">
                                ...
                                <div class="bg-indigo-50 px-4 md:px-6 py-3 border-t border-indigo-100">
                                    <a href="admin-course-application.php?page=index" class="text-sm text-indigo-700 hover:text-indigo-800 font-medium flex items-center transition-colors duration-200">
                                                ...
                                                <div class="flex items-start justify-between">
                                                    <div class="flex-1 min-w-0">
                                                        ...
                                                        <div class="flex items-center space-x-2 mt-3 pt-3 border-t border-gray-100">
                                                            <a href="admin-manage-students.php?page=view&id=<?php echo $student['student_id']; ?>" 
                        ...
                        <div id="student-applications" class="bg-white shadow-lg rounded-xl overflow-hidden border border-gray-100">
                            ...
                            <?php if (empty($recent_students)): ?>
                                <div class="text-center py-8 md:py-12">
                                    ...
                                    <a href="admin-manage-students.php?page=index" class="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-lg text-white bg-blue-900 hover:bg-blue-800">
                                                ...
                                                <div class="flex items-start justify-between">
                                                    <div class="flex-1 min-w-0">
                                                        ...
                                                        <div class="flex items-center gap-2 mt-3 pt-3 border-t border-gray-100">
                                                            <a href="admin-manage-students.php?page=view&id=<?php echo $student['id']; ?>" 
                            ...
                            <?php if (empty($recent_applications)): ?>
                                <div class="text-center py-8 md:py-12">
                                    ...
                                    <div class="flex flex-col sm:flex-row gap-3 justify-center">
                                        <a href="admin-course-application.php?page=index" class="inline-flex items-center px-4 py-2 bg-blue-600 text-white text-sm font-semibold rounded-lg hover:bg-blue-700 transition-colors duration-200">
                        ...
                        <div class="mt-6 md:mt-8 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
                            ...
                            <div class="bg-white shadow-lg rounded-xl p-4 md:p-6 border border-gray-100 hover:shadow-xl transition-shadow duration-300">
                                ...
                                <div class="space-y-2">
                                    <a href="admin-manage-courses.php?page=index" class="block text-blue-900 hover:text-blue-800 text-sm font-medium">
                                        <i class="fas fa-arrow-right mr-1"></i>Manage Courses
                                    </a>
                                    <a href="admin-manage-courses.php?page=add" class="block text-blue-900 hover:text-blue-800 text-sm font-medium">
