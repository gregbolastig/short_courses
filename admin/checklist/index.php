...
if (isset($_GET['success'])) {
    ...
    switch ($success_type) {
        case 'created':
            ...
            $modal_title = 'Checklist Item Created Successfully!';
            $modal_message = "The checklist item '{$item_name}' has been successfully added to your system.";
            $modal_icon = 'fas fa-check-circle';
            break;
        case 'updated':
            $success_message = 'Checklist item updated successfully!';
            $show_success_modal = true;
            $modal_title = 'Checklist Item Updated Successfully!';
            $modal_message = "The checklist item '{$item_name}' has been successfully updated.";
                ...
                <div class="text-center mb-8">
                    <div class="bg-green-50 rounded-xl p-4 mb-4 border border-green-200">
                        <div class="flex items-center justify-center space-x-3 mb-2">
                            ...
                            <span class="font-semibold text-gray-900 text-lg"><?php echo htmlspecialchars($_GET['name'] ?? 'Checklist Item'); ?></span>
                        </div>
                    </div>
                    <p class="text-gray-600 leading-relaxed">
                    ...
                    <div class="mt-4 p-3 bg-green-50 border border-green-200 rounded-lg">
                        <div class="flex items-center justify-center space-x-2 text-green-700">
                            <i class="fas fa-info-circle text-sm"></i>
                            <span class="text-sm font-medium">You can now manage this item from the list below</span>
                        </div>
                    </div>
                </div>
