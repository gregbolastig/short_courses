...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    try {
        ...
        $stmt = $conn->prepare("INSERT INTO checklist (document_name, is_required, display_order) VALUES (:document_name, :is_required, :display_order)");
        $stmt->bindParam(':document_name', $document_name);
        $stmt->bindParam(':is_required', $is_required);
        $stmt->bindParam(':display_order', $display_order);
        
        if ($stmt->execute()) {
            $_SESSION['success_message'] = 'Checklist item added successfully.';
            header('Location: index.php');
            exit();
        } else {
            $error_message = 'Failed to add checklist item.';
        }
            ...
            <div class="max-w-3xl mx-auto">
                ...
                <nav class="mb-4 text-sm">
                    <ol class="flex items-center space-x-2 text-gray-600">
                        ...
                        <li><i class="fas fa-chevron-right text-xs"></i></li>
                        <li class="text-gray-900 font-medium">Add Document</li>
                    </ol>
                </nav>
                ...
                <div class="mb-6">
                    <div class="flex items-center mb-4">
                        ...
                        <h1 class="text-3xl font-bold text-gray-900">
                            <i class="fas fa-plus-circle text-blue-900 mr-3"></i>
                            Add Document Requirement
                        </h1>
                    </div>
                    <p class="text-gray-600">Add a new document requirement to the checklist</p>
                </div>
