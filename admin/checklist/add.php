...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        ...
        header("Location: index.php?success=created&name=" . urlencode($document_name));
        exit();
...
<head>
    ...
    <title>Add Checklist Item - Student Registration System</title>
                                    ...
                                    <div>
                                        ...
                                        <div class="relative">
                                            ...
                                            <input type="text" name="document_name" id="document_name" required 
                                                   value="<?php echo isset($_POST['document_name']) ? htmlspecialchars($_POST['document_name']) : ''; ?>"
